                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">KQ điểm danh</h6>
                                </div>
                                <div class="card-body">
                                    <table class="table">
                                        <thead>
                                        ...
                                        <tbody>
                                            <tr>
                                                @foreach($diemdanh as $kq)
                                                <td>{{$kq->hoten}}</td>
                                                <td>{{$kq->mssv}}</td>
                                                <td>{{$kq->monhoc}}</td>
                                                <td>{{$kq->ngay}}</td>
                                                <td>{{$kq->trangthai}}</td>
                                                <td><a href="{{ route('xoadiemdanh', ['id' => $kq->id]) }}" class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn xóa không?')">Xóa</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
