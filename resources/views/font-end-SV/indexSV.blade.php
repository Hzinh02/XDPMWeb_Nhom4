...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('indexSV')}}">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{route('indexSV')}}">
            ...
            <li class="nav-item">
                ...
                $mssv = Auth::user()->usercode ?>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Điểm Danh</h6>
                        <a class="collapse-item" href="{{ route('kqdiemdanhSV',['mssv' => $mssv]) }}">Kết quả điểm danh</a>
